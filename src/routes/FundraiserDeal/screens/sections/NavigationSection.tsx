    ...
    <nav className="flex flex-col w-[260px] h-full items-start justify-between p-6 relative">
      <div className="flex flex-col items-start gap-6 relative self-stretch w-full flex-[0_0_auto]">
        <img
          ...
          src="https://c.animaapp.com/mfr838xgQVdAo5/img/header-container.svg"
        />
            ...
            >
              <div className="flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
                ...
                {section.items.map((item, itemIndex) => (
                  ...
                  >
                    <div className="flex items-center gap-2 relative flex-1 grow mt-[-0.50px] mb-[-0.50px]">
                      {item.customIcon ? (
                        <div className="relative w-5 h-5">
                          <img
                            ...
                            alt="Union"
                            src="https://c.animaapp.com/mfr838xgQVdAo5/img/union.svg"
                          />
                          <img
                            className="absolute w-full h-full top-0 left-0"
                            alt="Squircle"
                            src="https://c.animaapp.com/mfr838xgQVdAo5/img/squircle.svg"
                          />
                        </div>
                      ) : item.icon ? (
                      ...
                      <div
                        className={`flex-1 ${item.isActive ? "font-semibold" : "font-medium"} relative mt-[-1.00px] [font-family:'Manrope',Helvetica] text-[#111111] text-sm tracking-[0] leading-[21px] text-left`}
                      >
                        {item.label}
                      </div>
                    </div>
                    ...
                    {item.badge && (
                      <Badge className="flex w-6 h-6 items-center justify-center gap-2.5 p-2.5 relative mt-[-2.00px] bg-[#17a34a29] rounded text-[#17a34a] text-xs font-medium border-0">
                        {item.badge}
                      </Badge>
                    )}
                    ...
                    {!item.badge && !item.hasNotification && (
                      <div className="relative w-6 h-6 mt-[-2.00px] mb-[-2.00px]" />
                    )}
                  </Button>
                ))}
                ...
                <img
                  ...
                  src="https://c.animaapp.com/mfr838xgQVdAo5/img/menu-item-main-menu.svg"
                />
              </div>
            </div>
          ))}
