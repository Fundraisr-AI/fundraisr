...
export const NotificationSection = (): JSX.Element => {
  ...
  const renderNotificationDescription = (description: string | NotificationDescription) => {
      ...
      <nav className="flex mx-6 h-10 relative mt-[26px] items-center justify-between">
        ...
        <div className="inline-flex gap-4 flex-[0_0_auto] items-center relative">
          <div className="inline-flex items-center gap-2 relative flex-[0_0_auto]">
            <label htmlFor="unread-toggle" className="flex items-center cursor-pointer">
              ...
              <span className="ml-3 text-sm font-medium text-foreground">Only Show Unread</span>
            </label>
          </div>
