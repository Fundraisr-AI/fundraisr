...
import { CampaignCreationSection } from "./CampaignCreationSection";
import { UploadLeadListModalSection } from "./UploadLeadListModalSection";
import { CampaignReviewModalSection } from "./CampaignReviewModalSection";
...
export const OutreachCreate = ({
  isOpen,
  onClose,
}: OutreachCreateProps): JSX.Element => {
