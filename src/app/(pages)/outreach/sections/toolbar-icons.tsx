...
export const Bold: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      d="M4.5 2.5h4.5a3 3 0 0 1 0 6h-4.5V2.5zM4.5 8.5h5a3 3 0 0 1 0 6h-5v-6z"
      stroke="currentColor"
      strokeWidth="1.5"
      fill="none"
    />
...
export const Italic: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      d="M6.5 2.5h3M9.5 2.5l-2 11M6.5 13.5h3"
      stroke="currentColor"
      strokeWidth="1.5"
      fill="none"
    />
...
export const Striketrough: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      d="M4 8h8M6.5 2.5v3M9.5 2.5v3M6.5 10.5v3M9.5 10.5v3"
      stroke="currentColor"
      strokeWidth="1.5"
      fill="none"
    />
...
export const Quote: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      d="M4 6c0-1.5 1-3 3-3s3 1.5 3 3v4c0 1.5-1 3-3 3s-3-1.5-3-3M9 6c0-1.5 1-3 3-3s3 1.5 3 3v4c0 1.5-1 3-3 3s-3-1.5-3-3"
      stroke="currentColor"
      strokeWidth="1.5"
      fill="none"
    />
